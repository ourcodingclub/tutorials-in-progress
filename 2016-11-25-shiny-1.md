...
To get Shiny in RStudio the first thing you need is the `shiny` package, which you can get from [CRAN](https://cran.r-project.org/web/packages/shiny/index.html) using the code below:
